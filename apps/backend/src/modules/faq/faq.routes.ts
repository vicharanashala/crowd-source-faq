...
import { getAllFAQs, getFAQById, getRecentFAQs, createFAQ, updateFAQ, deleteFAQ, checkFAQMatch, getPaginatedFAQs, submitFeedback, reportFAQ, getFAQHistory, createFAQSuggestion, getFAQCategories, toggleSaveFAQ, getSavedFAQs } from './faq.controller.js';
...
// GET /api/faq/saved/items — Get user's saved FAQs
router.get('/saved/items', protect, getSavedFAQs);
...
router.post('/:id/save', protect, validateObjectId('id'), toggleSaveFAQ);
