...
import adminTrainRoutes from '../modules/admin/adminTrain.routes.js';
...
import faqAnalyticsRoutes from '../modules/faq/faq-analytics.routes.js';
...
export function registerRoutes(app: Express): void {
  ...
  router.use('/admin', adminTrainRoutes);
  ...
  router.use('/admin/faq-analytics', faqAnalyticsRoutes);
