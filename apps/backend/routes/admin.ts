...
// AI Feedback — public submit (no auth required)
router.post('/ai-feedback', submitAIFeedback);
...
// AI Response Feedback — admin views and FAQ edit action
router.get('/ai-feedback/stats', getAIFeedbackStats);
router.get('/ai-feedback', getAIFeedback);
router.patch('/ai-feedback/:faqId/edit-faq', editFAQFromFeedback);
