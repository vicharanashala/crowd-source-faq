...
function ChartIcon()   { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><line x1="3" y1="21" x2="21" y2="21"/><rect x="5" y="11" width="4" height="7" rx="1"/><rect x="11" y="7" width="4" height="11" rx="1"/><rect x="17" y="13" width="4" height="5" rx="1"/></svg>; }
