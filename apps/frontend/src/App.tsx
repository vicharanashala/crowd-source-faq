...
const AdminAIInsights = lazy(() => import('./admin/pages/AdminAIInsights'));
  ...
  return (
    <>
      <Routes>
        ...
        {/* AI Insights — feedback on AI responses */}
        <Route path="/admin/ai-insights" element={<AdminRoute><AdminLayout><AdminAIInsights /></AdminLayout></AdminRoute>} />
