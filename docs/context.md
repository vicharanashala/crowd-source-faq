...
- `GET /api/admin/ai-decision-health` — auto-answer daily verdict counts + avg confidence (`?days=`, `?batchId=`)
...
| GET | `/api/admin/ai-decision-health` | AI auto-answer daily verdicts + avg confidence (query: `days`, `batchId`) |
